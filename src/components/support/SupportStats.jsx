...
import '../../styles/support/SupportStats.scss';
  ...
  useEffect(() => {
    ...
    const intervalId = setInterval(() => {
      setAnimatedStats(prevStats => {
        const newTicketsResolved = Math.min(prevStats.ticketsResolved + Math.ceil(stats.ticketsResolved / 20), stats.ticketsResolved);
        const newSatisfaction = Math.min(prevStats.customerSatisfaction + (stats.customerSatisfaction / 20), stats.customerSatisfaction);
        const newOpenTickets = Math.min(prevStats.openTickets + Math.ceil(stats.openTickets / 10), stats.openTickets);
