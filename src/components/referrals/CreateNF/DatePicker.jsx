...
// Componente de DatePicker personalizado con solución de z-index
const CustomDatePicker = ({ 
  ...
  const getMonthYearDisplay = () => {
    ...
    return `${capitalizedMonth} De ${currentMonth.getFullYear()}`;
  };
  ...
  const generateDays = () => {
    ...
    const daysFromNextMonth = 42 - (daysFromPrevMonth + daysInMonth); // 42 = 6 semanas x 7 días
              ...
              <div className="days">
                {generateDays().map((day, index) => (
                  <div
                    ...
                    onClick={(e) => { 
                      e.stopPropagation(); 
                      if (day.isCurrentMonth) selectDay(day); 
                    }}
                  >
                    {day.day}
                  </div>
